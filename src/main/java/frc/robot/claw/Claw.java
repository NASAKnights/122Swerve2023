...
public class Claw extends SubsystemBase {
  ...
  public Claw() {
    ...
    // this.pHub = pHub;
    this.clawSolenoid = new NKDoubleSolenoid(2,PneumaticsModuleType.REVPH, 
    Constants.PneumaticConstants.kSolenoidForward, Constants.PneumaticConstants.kSolenoidReverse);
